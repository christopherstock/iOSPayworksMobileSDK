...
#import "MPProvider.h"
@class MPProviderOptionsExtension;
...
/**
 * Provide the actions you are able to handle in your application. This will determine if you are able to start a specific transaction (based on the actions required for the
 * transaction internally). If no action is provided, it is expected that you are able to handle all specified actions
 * @since 2.0.0
 */
