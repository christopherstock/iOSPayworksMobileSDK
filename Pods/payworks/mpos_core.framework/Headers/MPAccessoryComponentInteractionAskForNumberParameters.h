 ...
 * @since 2.10.0
 */
- (void)setDefaultNumber:(nullable NSDecimalNumber *)defaultNumber;
 ...
 * @since 2.10.0
 */
- (void)setDisplayAmount:(NSDecimalNumber *)amount currency:(MPCurrency)currency;
...
typedef void (^MPAccessoryComponentInteractionAskForNumberOptionals)(id<MPAccessoryComponentInteractionAskForNumberOptionals> optionals);
 ...
 * @since 2.10.0
 */
+ (instancetype)parametersWithPrompt:(MPAccessoryComponentInteractionPrompt)prompt optionals:(nullable MPAccessoryComponentInteractionAskForNumberOptionals)optionalsBlock;
 ...
 * @since 2.10.0
 */
+ (instancetype)parametersWithPromptIndexes:(NSArray<NSNumber *> *)promptIndexes optionals:(nullable MPAccessoryComponentInteractionAskForNumberOptionals)optionalsBlock;
