 ...
 * @since 2.0.0
 */
@property (assign, readwrite, nonatomic) MPAccessoryType type;

/**
 * Information about the device (including software version), only available once connected.
 * @since 2.0.0
 */
@property (strong, readwrite, nonatomic, nonnull) MPAccessoryDetails *details;
 ...
 * @since 2.18.0
 */
@property (strong, readwrite, nonatomic, nonnull) MPAccessoryParameters *parameters;
