...
+ (id <CoreFeatureToggleManager> _Nullable)createWithOptions:(MPProviderOptions * _Nonnull)options SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSURLSessionConfiguration * _Nullable sessionConfiguration;)
+ (NSURLSessionConfiguration * _Nullable)sessionConfiguration SWIFT_WARN_UNUSED_RESULT;
+ (void)setSessionConfiguration:(NSURLSessionConfiguration * _Nullable)newValue;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
