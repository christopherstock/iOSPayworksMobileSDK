 ...
 * @since 2.0.0
 */
- (nonnull MPProviderOptions *)providerOptionsWithMode:(MPProviderMode)mode
                                     merchantIdentifer:(nonnull NSString *)merchantIdentifier
                                     merchantSecretKey:(nonnull NSString *)merchantSecretKey
                                      supportedActions:(MPTransactionAction)supportedActions;
