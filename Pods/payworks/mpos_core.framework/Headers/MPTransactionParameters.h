 ...
 * @since 2.24.0
 */
@property (nonatomic, nullable, strong) NSString *customIdentifier;
 ...
 * @since 2.24.0
 */
@property (nonatomic, nullable, strong) NSString *statementDescriptor;

/**
 * The fee that will be added to the transaction costs.
 * @since 2.24.0
 */
@property (nonatomic, nullable, strong) NSDecimalNumber *applicationFee;
 ...
 * @since 2.24.0
 */
@property (nonatomic, nullable, strong) NSDictionary<NSString *, NSString *> *metadata;
 ...
 * @since 2.24.0
 */
@property (nonatomic, nullable, strong) NSDecimalNumber *includedTipAmount;
 ...
 * @since 2.32.0
 */
+ (nonnull instancetype)activationWithAmount:(nonnull NSDecimalNumber *)amount
                                    currency:(MPCurrency)currency
                                   optionals:(nullable MPTransactionParametersActivationOptionalsBlock)optionalsBlock;
 ...
 * @since 2.24.0
 */
+ (nonnull instancetype)refundWithAmount:(nonnull NSDecimalNumber *)amount
                                currency:(MPCurrency)currency
                               optionals:(nullable MPTransactionParametersStandaloneRefundOptionalsBlock)optionalsBlock;
 ...
 * @since 2.22.0
 */
+ (nonnull instancetype)tipAdjustForTransactionIdentifier:(nonnull NSString *)transactionIdentifier
                                                optionals:(nullable MPTransactionParametersTipAdjustOptionalsBlock)optionalsBlock;
