...
typedef NS_ENUM(NSUInteger, MPMockConfigurationGatewayBehavior) {
    ...
    /** The transaction reinitializes to ICC due to Strong Customer Authentication  */
    MPMockConfigurationGatewayBehaviorRequestSwitchToIccARC1A,
    MPMockConfigurationGatewayBehaviorRequestSwitchToIccARC65,
    MPMockConfigurationGatewayBehaviorRequestSwitchToIccARC70,
    MPMockConfigurationGatewayBehaviorRequestSwitchToIccARC130,
    /** The transaction requests online PIN due to Strong Customer Authentication  */
    MPMockConfigurationGatewayBehaviorRequestOnlinePINARC65,
    MPMockConfigurationGatewayBehaviorRequestOnlinePINARC70,
    /** The transaction requests second tap with the payment device due to Strong Customer Authentication  */
    MPMockConfigurationGatewayBehaviorRequestCustomerDeviceReauthenticationARC1A,
    MPMockConfigurationGatewayBehaviorRequestCustomerDeviceReauthenticationARC70,
    MPMockConfigurationGatewayBehaviorBlockAccountVerificationForVisa,
};
...
- (BOOL)isRequestSwitchToIcc;
- (BOOL)isRequestOnlinePIN;
- (BOOL)isRequestCustomerDeviceReauthentication;
- (NSString *)arc;
