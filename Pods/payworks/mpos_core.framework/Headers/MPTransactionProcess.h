 ...
 * @since 2.2.0
 */
typedef void (^MPTransactionProcessActionRequired)(MPTransactionProcess *_Nonnull transactionProcess,
                                                   MPTransaction *_Nonnull transaction,
                                                   MPTransactionAction action,
                                                   MPTransactionActionSupport *_Nullable support);
 ...
 * @since 2.2.0
 */
- (void)continueWithCustomerSignature:(nullable UIImage *)signature verified:(BOOL)verified;
