...
/**
 * Failure handler for the execution of a transaction. There are different reasons why a transaction may fail: network errors, missing parameters, invalid payment details). Some of
 * those errors are recoverable (e.g. by just starting the transaction again). The error will provide information about the recoverability. The error is also attached to the transaction as an error property, giving access to it at a later stage.
 ...
 * @since 2.6.0
 */
typedef void (^MPTransactionQuerySuccess)(NSArray<MPTransaction *> *_Nonnull transactions);
 ...
 * @since 2.0.0
 */
@property (strong, readonly, nonatomic, nonnull) NSSet<MPAccessory *> *accessories;
 ...
 * @since 2.42.0
 */
@property (assign, nonatomic) NSUInteger maxReceiptLineLength;
 ...
 * @since 2.5.0
 */
- (void)connectToAccessoryWithParameters:(nonnull MPAccessoryParameters *)parameters
                                 success:(nonnull MPAccessoryConnectSuccess)success
                                 failure:(nonnull MPAccessoryConnectFailure)failure;
 ...
 * @since 2.0.0
 */
- (void)checkUpdateRequirementForAccessory:(nonnull MPAccessory *)accessory
                                   success:(nonnull MPAccessoryCheckUpdateSuccess)success
                                   failure:(nonnull MPAccessoryCheckUpdateFailure)failure;
 ...
 * @since 2.0.0
 */
- (void)lookupTransactionWithSessionIdentifier:(nonnull NSString *)identifier
                                       success:(nonnull MPTransactionLookupSuccess)success
                                       failure:(nonnull MPTransactionLookupFailure)failure;
 ...
 * @since 2.3.0
 */
- (void)lookupTransactionWithTransactionIdentifier:(nonnull NSString *)identifier
                                           success:(nonnull MPTransactionLookupSuccess)success
                                           failure:(nonnull MPTransactionLookupFailure)failure;
 ...
 * @since 2.5.0
 */
- (void)registerTransactionWithParameters:(nonnull MPTransactionParameters *)parameters
                                  success:(nonnull MPTransactionCreateSuccess)success
                                  failure:(nonnull MPTransactionCreateFailure)failure;
 ...
 * @since 2.2.0
 */
- (void)startTransaction:(nonnull MPTransaction *)transaction
          usingAccessory:(nonnull MPAccessory *)accessory
                approval:(nonnull MPTransactionApproval)approval
                 decline:(nonnull MPTransactionDecline)decline
                   abort:(nonnull MPTransactionAbort)abort
                 failure:(nonnull MPTransactionFailure)failure
          actionRequired:(nonnull MPTransactionActionRequired)actionRequired;
 ...
 * @since 2.22.0
 */
- (void)executeTransaction:(nonnull MPTransaction *)transaction
 ...
 * @since 2.11.0
 */
- (void)abortTransaction:(nonnull MPTransaction *)transaction
                  reason:(MPTransactionAbortReason)reason
                 success:(nonnull MPTransactionAbortSuccess)success
                 failure:(nonnull MPTransactionAbortFailure)failure;
 ...
 * @since 2.8.0
 */
- (void)captureTransactionWithParameters:(nonnull MPTransactionParameters *)parameters
                                 success:(nonnull MPTransactionCaptureSuccess)success
                                 failure:(nonnull MPTransactionCaptureFailure)failure;
...
- (void)sendCustomerReceiptForTransactionIdentifier:(nonnull NSString *)transactionIdentifier
                                       emailAddress:(nonnull NSString *)emailAddress
                                            success:(nonnull MPCustomerReceiptSendingSuccess)success
                                            failure:(nonnull MPCustomerReceiptSendingFailure)failure;
 ...
 * @since 2.5.0
 */
- (void)refundTransactionWithoutCardForParameters:(nonnull MPTransactionParameters *)transactionParameters
                                         approved:(nonnull MPRefundTransactionWithoutCardApproved)approved
                                         declined:(nonnull MPRefundTransactionWithoutCardDeclined)declined
                                          failure:(nonnull MPRefundTransactionParamsWithoutCardFailure)failure;
 ...
 * @since 2.8.0
 */
- (void)refundTransactionWithParameters:(nonnull MPTransactionParameters *)transactionParameters
                               approved:(nonnull MPRefundTransactionApproved)approved
                               declined:(nonnull MPRefundTransactionDeclined)declined
                                failure:(nonnull MPRefundTransactionFailure)failure;
 ...
 * @since 2.22.0
 */
- (void)tipAdjustTransactionWithParameters:(nonnull MPTransactionParameters *)transactionParameters
                                   success:(nonnull MPTransactionTipAdjustSuccess)success
                                   failure:(nonnull MMPTransactionTipAdjustFailure)failure;
