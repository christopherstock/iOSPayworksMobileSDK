 ...
 * @since 2.5.0
 */
@property (nonatomic, nullable, strong) NSArray<NSString *> *idleText;

/**
 * The language to use for displaying information and prompts on the display.
 * @since 2.5.0
 */
@property (nonatomic, assign) MPLocale locale;
 ...
 * @since 2.5.0
 */
@property (nonatomic, nullable, strong) NSString *namePrefix;
 ...
 * @since 2.5.0
 */
@property (strong, readonly, nonatomic, nullable) NSDictionary<NSString *, id> *filters;

/**
 * The text displayed as an idle screen.
 * @since 2.5.0
 */
@property (strong, readonly, nonatomic, nullable) NSArray<NSString *> *idleText;
 ...
 * @since 2.5.0
 */
+ (nonnull instancetype)externalAccessoryParametersWithFamily:(MPAccessoryFamily)family
                                                     protocol:(nonnull NSString *)protocol
                                                    optionals:(nullable MPExternalAccessoryOptionalsBlock)optionalsBlock;
 ...
 * @since 2.6.0
 */
+ (nonnull instancetype)tcpAccessoryParametersWithFamily:(MPAccessoryFamily)family
                                                  remote:(nonnull NSString *)remote
                                                    port:(NSUInteger)port
                                               optionals:(nullable MPAccessoryOptionalsBlock)optionalsBlock;
