...
/**
 * Starts and returns a new deferred authorization transaction process which will guide you through a complete transaction.
...
/**
 * Starts an amendment process, that can be used for modifying a previous deferred authorization transactions.
...
/**
 * Submit all currently stored deferred authorization transactions for settlement.
 ...
 * @since 2.28.0
 */
- (void)lookupTransactionWithTransactionIdentifier:(nonnull NSString *)transactionIdentifier completed:(nonnull MPOfflineModuleLookupByTransactionIdentifierCompleted)completed;

/**
 * Queries all stored deferred authorization transactions. Transactions are sorted by time descending.
 ...
 * @since 2.28.0
 */
- (void)queryTransactionsWithRange:(NSRange)range includeReceipts:(BOOL)includeReceipts completed:(nonnull MPOfflineModuleQueryCompleted)completed;
