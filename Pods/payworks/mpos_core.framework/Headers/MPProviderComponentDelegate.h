 ...
 * @since 2.0.0
 */
- (void)provider:(nonnull MPProvider *)provider
        didRequestDisplayUpdateForType:(MPProviderComponentDelegateDisplayUpdateType)type
                                  text:(nonnull NSArray<NSString *> *)text
                               support:(nonnull MPDisplayUpdateSupport *)support;
