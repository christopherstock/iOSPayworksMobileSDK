...
/**
 * Receipt in text form (array of lines). Uses customizations for location-specific receipts
 * @returns Array of strings representing the consecutive lines of the receipt
 * @since 2.42.0
 */
@property (strong, readonly, nonatomic, nullable) NSArray<NSString *> *lines;
